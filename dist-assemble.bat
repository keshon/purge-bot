...
set TARGET_PLATFORM=purgebot-win
...
set OUTPUT_ARCHIVE=dist\purgebot-bot-win-v%CURRENT_DATE%.zip
...
copy purgebot.exe dist\%TARGET_PLATFORM%
...
%UPX_PATH% --best dist\%TARGET_PLATFORM%\purgebot.exe
