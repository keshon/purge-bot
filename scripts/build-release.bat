...
rem Build command
go build -o purgebot.exe -ldflags "-s -X github.com/keshon/purge-bot/internal/version.BuildDate=%BUILD_DATE% -X github.com/keshon/purge-bot/internal/version.GoVersion=%GO_VERSION%" cmd\purgebot\purgebot.go
